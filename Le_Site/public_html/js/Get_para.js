...
function ouvre_calc_fr(){
	...
	window.open("Calculs.html","childWindow","width=600,height=650,toolbar=no,location=no,directories=no,menubar=no,scrollbars=yes,copyhistory=no,resizable=yes,left=500");
...
function ouvre_calc_Noire_fr(){
	...
	// Ouverture de la fenêtre
	window.open("Calculs_noire.html","childWindow","width=600,height=650,toolbar=no,location=no,directories=no,menubar=no,scrollbars=yes,copyhistory=no,resizable=yes,left=500");
...
function transfert_simu(){
	window.opener.document.getElementById("T0").value=Number(document.getElementById('Hz1').innerHTML);
	window.opener.document.getElementById("H0").value=Number(document.getElementById('Tz1').innerHTML);
