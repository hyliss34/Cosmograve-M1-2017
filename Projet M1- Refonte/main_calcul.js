...
function calcul(){   // fonction principale de cosmograve
	...
	document.getElementById("resultat_omegar0").innerHTML = Or.toExponential();
...
function graphique_creation(){
    ...
    b.append("text").attr("class", "legend_titre").attr("x", wid/2-130).attr("y", -15).attr("dy", ".3em").attr("transform", "rotate(0)").style("font-weight", "bold").style("font-size", "1.3em").text("Evolution du facteur d'\u00e9chelle r\u00e9duit");
