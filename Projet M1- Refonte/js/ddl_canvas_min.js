function dlCanvas() {
    ...
    if ("pdf" == document.getElementById("type").options[document.getElementById("type").selectedIndex].text) {
        ...
        var e = canvas_1.toDataURL("Images/jpeg", 1),
            d = new jsPDF;
        context_1.clearRect(0, 0, a, b);
        context_1.putImageData(data, 0, 0);
    ...
    }, "Images/" + document.getElementById("type").options[document.getElementById("type").selectedIndex].text), context_1.clearRect(0, 0, a, b), context_1.putImageData(data,
