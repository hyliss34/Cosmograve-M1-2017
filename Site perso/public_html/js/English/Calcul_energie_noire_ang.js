...
function Calc(){
	...
	document.getElementById("resultat_omegak0").innerHTML = Number(omegak0_afficher).toExponential(3);
...
function graphique_creation_noir_ang(){
	...
	annots = [{
		...
		yref:'paper',
		yanchor:'bottom',
		text: '<b>Inputs</b><br>'+'T<sub>0</sub>:'+t0+'<br>'+'H<sub>0:</sub>'+h0+'<br>'+'Omega<sub>m0</sub>:'+omegam0+'<br>Omega<sub>DE0</sub>:'+omegaDE0,
