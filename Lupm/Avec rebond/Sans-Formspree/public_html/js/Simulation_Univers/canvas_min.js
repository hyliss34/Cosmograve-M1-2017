...
// Fonctions nécéssaires à 'linteractivité et au tracer du Canvas contant les separactrices
...
function update_modele() {
    ...
    context.fillText("Pas de BC", 140, 220);
    context.font = "8pt Verdana";
    context.fillStyle = "green";
    context.fillText("Big Crunch", 170, 260);
