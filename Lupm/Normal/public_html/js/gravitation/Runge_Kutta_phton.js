...
function fonction(r) {
	...
	//return 6*m*Math.pow(c*L,2)/Math.pow(r,4)+2*Math.pow(c*L,2)/Math.pow(r,3);
//MODIFICATION PHOTON//-Math.pow(c,2)*(2*m/Math.pow(r,2)-2*Math.pow(L,2)/Math.pow(r,3)+6*m*Math.pow(L,2)/Math.pow(r,4));
return -Math.pow(c,2)*(-2*Math.pow(L,2)/Math.pow(r,3)+6*m*Math.pow(L,2)/Math.pow(r,4));  
						}
